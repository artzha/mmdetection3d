...
class CODa2KITTI(object):
    ...
    def __init__(self,
        ...
        self.selected_coda_classes = ['CAR', 'PEDESTRIAN', 'BIKE']
    ...
    def convert_one(self, file_idx):
        ...
        self.save_lidar(traj, frame_idx, file_idx)
    ...
    def save_lidar(self, traj, frame_idx, file_idx):
    ...
    def save_label(self, traj, cam_id, frame_idx, file_idx):
        ...
        twod_anno_dict = np.loadtxt(twod_anno_path, dtype=np.int)
    ...
    def save_timestamp(self, traj, frame_idx, file_idx):
        ...
        frame_to_ts_file = "%s_frame_to_ts.txt" % traj
